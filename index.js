...
async function connectToWA() {
  ...
  console.log("Connecting ❤️𝙺_𝙰_𝙳_𝙰_𝚈_𝙰__𝙼𝙳❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️𝙺_𝙰_𝙳_𝙰_𝚈_𝙰__𝙼𝙳❤️ installed successful ✅");
      console.log("❤️𝙺_𝙰_𝙳_𝙰_𝚈_𝙰__𝙼𝙳❤️ connected to whatsapp ✅");

      let up = `❤️𝙺_𝙰_𝙳_𝙰_𝚈_𝙰__𝙼𝙳❤️ connected successful ✅`;
...
app.get("/", (req, res) => {
  res.send("hey, 💚𝙺_𝙰_𝙳_𝙰_𝚈_𝙰__𝙼𝙳❤️ started✅");
});
app.listen(port, () =>
